...
class AppTheme {
  static const Color cBg = Color(0xFFFBFBFA);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFE8E7E4);
  static const Color cAccent = Color(0xFF4F46E5);
  static const Color cAccent2 = Color(0xFF818CF8);
  static const Color cInk = Color(0xFF1E1B4B);
